// src/canvas/shape/sea.js
import { clamp01, val, mix } from './utils/useLerp.ts';
import { blendRGB, blendRGBGamma } from './utils/colorBlend.ts';
import {
  clampSaturation,
  clampBrightness,
  oscillateSaturation,
} from '../color/colorUtils.ts';
import { stepAndDrawPuffs } from './particles/particle-2.ts'; // foam + spill
import { applyShapeMods } from './utils/shapeMods.ts';

// --- base palettes (exported) ---
