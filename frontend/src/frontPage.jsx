...
import RadialBackground from './components/static/radialBackground.jsx';
import Survey from './components/survey/survey.tsx';
import Navigation from './components/nav/navigation.jsx';
import CityButton from './components/nav/CityButton.tsx';
import DataVisualization from './components/dotGraph/dataVisualization.jsx';
import { useDynamicMargin } from './utils/dynamicMargin.ts';
import { AppProvider, useAppState } from "./context/appStateContext.tsx";
...
const CanvasEntry = React.lazy(() =>
  import(/* webpackChunkName: "canvas-entry" */ './canvas/index.jsx')
);
...
const ModeToggle = React.lazy(() =>
  import(/* webpackChunkName: "mode-toggle" */ './components/nav-bottom/modeToggle.jsx')
);
...
const FrontPageInner = () => {
  ...
  useEffect(() => {
    ...
    const prefetch = () => {
      import(/* webpackPrefetch: true, webpackChunkName: "canvas-entry" */ './canvas/index.jsx');
    };
